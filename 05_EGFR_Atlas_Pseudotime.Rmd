...
A continuación, se estudia la trayectoria de las células. Para eso, se reducen las dimensiones a dos con la función `reduceDimension()` y el argumento `max_components = 2`, para poder ordenar las células con la función `orderCells()`.

```{r}
T_monocle <- differentialGeneTest(T_monocle)
T_monocle <- reduceDimension(T_monocle, max_components=2)
