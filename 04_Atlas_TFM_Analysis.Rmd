...
egfr_ex21L858R_female <- subset(egfr_female, subset = EGFR_mutation_type == "ex21L8458R")
...
sort(prop.table(table(egfr_female@meta.data$driver_gene)))
sort(prop.table(table(egfr_male@meta.data$driver_gene)))
